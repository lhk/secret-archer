...
make_install("Building and installing Thor release library" ${THORDIR})

if(${BUILD_SFML_DEBUG_LIBS})
  cmake_configure(${THORDIR} -DCMAKE_BUILD_TYPE=Debug)
  make_install("Building and installing Thor debug library" ${THORDIR})
endif()

if(${BUILD_SFML_DOC})
  cmake_configure(${THORDIR} -DTHOR_BUILD_DOC=TRUE)
  make_install("Building and installing Thor docs" ${THORDIR} ERROR_QUIET)
endif()
