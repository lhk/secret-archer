...
execute_process(COMMAND ${CMAKE_COMMAND} -G ${SFML_MAKEFILE_GENERATOR} -DSFML_INCLUDE_DIR=${SFML_INSTALL_PREFIX}/include -DCMAKE_INSTALL_PREFIX=${THOR_INSTALL_PREFIX}
                 WORKING_DIRECTORY ${THORDIR}
                 OUTPUT_QUIET
                 RESULT_VARIABLE RESULT
                )
